...
const enemy1 = new Enemy(-101, 11, 60); //declares enemy stores enemy object in variable
const enemy2 = new Enemy(-101, 112, 200);
const enemy3 = new Enemy((-101 * 2.5), 213, 100);
